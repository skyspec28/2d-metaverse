    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('type', models.CharField(choices=[('furniture', 'Furniture'), ('interactive', 'Interactive Object'), ('decoration', 'Decoration'), ('portal', 'Portal'), ('spawn', 'Spawn Point')], max_length=20)),
                ('sprite_url', models.URLField()),
                ('is_walkable', models.BooleanField(default=False)),
                ('interaction_script', models.TextField()),
            ],
        ),
        migrations.CreateModel(
            name='Map',
        ...
        migrations.AddField(
            model_name='map',
            name='elements',
            field=models.ManyToManyField(related_name='maps', through='api.MapElement', to='api.element'),
        ),
        migrations.CreateModel(
            name='Space',
            fields=[
